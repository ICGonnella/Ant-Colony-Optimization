...
T_max, start, end, d = dpp.load_problem(num=2, n_nodes=50)
n = len(d)
...
dpp.plot_solution(num=2, start=start, end=end, n=n)
# generate the features
features = ts.obtain_testing_set(start=2, num=3, n_nodes=n)
...
ant_hill.MMAS(200, global_=True)  # tau matrix updated by the global-best ant
ant_hill.plot()  # plot the solution found
